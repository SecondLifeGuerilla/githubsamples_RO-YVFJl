                    ...
                    execute: function () {
                        ...
                        const buttonDown = evt => {
                            ...
                            if (evt.gamepad.navigatorGamePadId === 'mouse') {
                                ...
                                plane.setFromNormalAndCoplanarPoint(RODIN.Scene.HMDCamera._threeCamera.getWorldDirection(), obj.position);
                         ...
                         */
                        const elements = [];
                        const types = [() => new RODIN.Sphere(0.25, new THREE.MeshNormalMaterial()), () => new RODIN.Box(0.5, new THREE.MeshNormalMaterial()), () => new RODIN.Cylinder(0.25, 0.25, 1, new THREE.MeshNormalMaterial())];
                        for (let i = 0; i < 40; i++) {
