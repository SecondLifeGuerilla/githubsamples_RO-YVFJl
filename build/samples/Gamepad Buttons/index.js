            ...
            System.register(['rodin/core'], function (_export, _context) {
                ...
                return {
                    ...
                    execute: function () {
                         ...
                         */
                        const plane = new RODIN.Plane(50, 50, 100, 100, new THREE.MeshBasicMaterial({
                            color: 0x35a9ff,
                            wireframe: true,
                        ...
                        carBody.on(RODIN.CONST.UPDATE, evt => {
                             ...
                             */
                            if (RODIN.GamePad.getButtonDown(RODIN.Buttons.viveLeftTrigger) || RODIN.GamePad.getButtonDown(RODIN.Buttons.oculusTouchLeftTrigger) || (RODIN.GamePad.getButtonDown(RODIN.Buttons.mouseRight) || RODIN.GamePad.getButtonDown(RODIN.Buttons.cardboardTrigger)) && direction) {
                                moving = true;
                             ...
                             */
                            if (RODIN.GamePad.getButtonDown(RODIN.Buttons.viveRightTrigger) || RODIN.GamePad.getButtonDown(RODIN.Buttons.oculusTouchRightTrigger) || (RODIN.GamePad.getButtonDown(RODIN.Buttons.mouseRight) || RODIN.GamePad.getButtonDown(RODIN.Buttons.cardboardTrigger)) && !direction) {
                                moving = true;
                                step = 0.01 * RODIN.Time.delta;
                            }
                             ...
                             * Car stops
                             */
                            if (RODIN.GamePad.getButtonUp(RODIN.Buttons.viveLeftTrigger) || RODIN.GamePad.getButtonUp(RODIN.Buttons.oculusTouchLeftTrigger) || RODIN.GamePad.getButtonUp(RODIN.Buttons.mouseRight) || RODIN.GamePad.getButtonUp(RODIN.Buttons.viveRightTrigger) || RODIN.GamePad.getButtonUp(RODIN.Buttons.oculusTouchRightTrigger) || RODIN.GamePad.getButtonUp(RODIN.Buttons.cardboardTrigger)) {
                                moving = false;
                            }
