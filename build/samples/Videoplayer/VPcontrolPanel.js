            ...
            System.register(["rodin/core"], function (_export, _context) {
                ...
                return {
                    ...
                    execute: function () {
                        ...
                        class VPcontrolPanel extends RODIN.Sculpt {
                            ...
                            createBackGround(distance, width) {
                                ...
                                let sphere = new RODIN.Sculpt(new THREE.Mesh(new THREE.SphereBufferGeometry(r, 12, 12), new THREE.MeshBasicMaterial({
                                    color: 0x000000,
                                    transparent: true,
                                    opacity: 0.3,
                                    //wireframe:true,
                            ...
                            createCover(distance, width) {
                                ...
                                let coverMesh = new THREE.Mesh(new THREE.SphereBufferGeometry(r, 720, 4), new THREE.MeshBasicMaterial({
                                    color: 0xffffff,
