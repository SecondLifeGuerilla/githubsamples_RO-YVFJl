System.register([], function (_export2, _context2) {
    ...
    return {
        setters: [],
        execute: function () {
            System.register(['rodin/core', './ButtonsControlPanel.js'], function (_export, _context) {
                "use strict";

                var RODIN, ButtonsControlPanel;
                return {
                    setters: [function (_rodinCore) {
                        RODIN = _rodinCore;
                    }, function (_ButtonsControlPanelJs) {
                        ButtonsControlPanel = _ButtonsControlPanelJs.ButtonsControlPanel;
                    }],
                    execute: function () {
                        RODIN.start();
